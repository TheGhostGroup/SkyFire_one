...
class Battleground
{
    ...
    public:
        ...
        virtual void EventPlayerDamagedGO(Player* player, GameObject* go, uint8 hitType, uint32 destroyedEvent) {}
        ...
        void AddOrSetPlayerToCorrectBgGroup(Player* player, uint64 plr_guid, uint32 team);
